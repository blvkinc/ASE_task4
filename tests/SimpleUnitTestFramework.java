...
public class SimpleUnitTestFramework {
    ...
    public static void assertPrivateField(Object obj, String fieldName, String expectedValue) {
        try {
            Field privateField = obj.getClass().getDeclaredField(fieldName);
            privateField.setAccessible(true);
            Object actualValue = privateField.get(obj);

            if (actualValue instanceof String) {
                SimpleUnitTestFramework.assertEquals(expectedValue, (String) actualValue);
            } else {
                SimpleUnitTestFramework.logWarning(String.format("Field %s is not of type String", fieldName));
            }
